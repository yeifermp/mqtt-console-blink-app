...
# 53 "/opt/microchip/xc8/v2.31/pic/include/proc/pic18f4553.h"
...
# 19 "/opt/microchip/xc8/v2.31/pic/include/pic18.h"
...
# 53 "/opt/microchip/xc8/v2.31/pic/include/proc/pic18f4550.h"
extern volatile unsigned char SPPDATA __at(0xF62);
...
# 4 "/opt/microchip/xc8/v2.31/pic/include/__size_t.h"
...
# 15 "/opt/microchip/xc8/v2.31/pic/include/c90/stdbool.h"
...
static const char * LED_ON_CMD = "<LedOn>";
static const char * LED_ON_OFF = "<LedOff>";
...
action_t get_action () {
if (is_command(LED_ON_CMD)) {
return LED_ON;
} else if(is_command(LED_ON_OFF)) {
return LED_OFF;
}
